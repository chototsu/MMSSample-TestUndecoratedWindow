...
public class TestAwtPanels extends SimpleApplication {
    ...
    private static void createWindowForPanel(AwtPanel panel, int location){
        JFrame frame = new JFrame("Render Display aa" + location);
        frame.setUndecorated(true);
        frame.setBackground(new Color(0,0,0,0));
//        frame.setOpacity(0.5f);
//        frame.getContentPane().setBackground(new Color(0.5f,0f,0f,1f));
        panel.setBackground(new Color(0.5f,0f,0f,0f));
    ...
    public void simpleInitApp() {
        ...
        viewPort.setBackgroundColor(new ColorRGBA(0.0f,0.0f,0.0f,0.5f));
